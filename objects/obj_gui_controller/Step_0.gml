if instance_exists(obj_character) {
	if (obj_character.reloading and current_x != screen_width) and global.t != 0 {
	...
	} else if (!obj_character.reloading and current_x != screen_width) and global.t != 0{
		if current_x < camera_width
			current_x += 10
		else if current_x > camera_width
